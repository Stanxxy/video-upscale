...
Both scores are combined with a weighted sum. Thresholds are tuned in `tracking_pipeline/identity_manager.py`.
...
## Impact
- `tracking_pipeline/identity_manager.py` — re-ID implementation
